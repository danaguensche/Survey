...
class SurveyQuestionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $fragen = [
            ...
            ['section_id' => '4', 'question_text' => 'In der betrieblichen Phase konnte ich die im Berufsbildungswerk erlernten Inhalte anwenden.', 'type' => 'rating', 'scale_max' => 6, 'order_index' => 11],
            ['section_id' => '4', 'question_text' => 'Im Ausbildungsjahr fand keine betriebliche Phase statt.', 'type' => 'rating', 'scale_max' => 6, 'order_index' => 12],
            ['section_id' => '5', 'question_text' => 'Das Ausbildungsjahr hat mich fachlich und persönlich weitergebracht.', 'type' => 'rating', 'scale_max' => 6, 'order_index' => 13],
