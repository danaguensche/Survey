...
class SurveyQuestionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $fragen = [
            ...
            ['section_id' => '2', 'question_text' => 'Die Ausbilder und Lehrkräfte vermittelten die Ausbildungsinhalte verständlich und Praxisnah', 'type' => 'rating', 'scale_max' => 6, 'order_index' => 3],
